...
import {
  ...
  workScene2Config,
  workScene3Config,
} from "@/storyboard/scenes/04-work-1/WorkScene.config";
...
const workProjects = [
  {
    ...
    description:
      "A complete digital transformation for a luxury fashion brand, combining elegant design with powerful e-commerce functionality. Built with Next.js and headless CMS for maximum flexibility.",
  ...
  },
  {
    ...
    description:
      "An immersive 3D portfolio showcasing architectural visualizations. Built with React Three Fiber and custom shaders for stunning visual effects.",
  ...
  },
  {
    ...
    description:
      "A meditation and wellness app focused on accessibility and user experience. Features include guided sessions, progress tracking, and community features.",
